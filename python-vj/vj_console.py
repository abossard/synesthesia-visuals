...
class VJConsoleApp(App):
    ...
    def _update_audio_feature_panel(self) -> None:
        ...
        try:
            ...
            # Panel not mounted yet - this is expected during initialization
            return
        rows = []
    ...
    def _update_audio_panels(self) -> None:
        ...
        try:
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Audio analysis panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Audio device panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Audio stats panel not available, skipping update")
    ...
    def _update_services(self) -> None:
        ...
        try:
            ...
            # Panel not mounted yet or screen switched - this is expected during initialization
            logger.debug("Services panel not available, skipping update")
    ...
    def _update_data(self) -> None:
        ...
        if screen == "overview":
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Worker status panel not available, skipping update")
            try:
                self.query_one("#worker-highlights", WorkerHighlightsPanel).highlights = worker_highlights
            except NoMatches:
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Worker highlights panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Now playing panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Categories panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Pipeline panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("OSC mini panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Master control panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("OSC full panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Categories full panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Pipeline full panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Logs panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("Lyrics panel not available, skipping update")
            ...
            try:
                ...
                # Panel not mounted yet or screen switched - this is expected during initialization
                logger.debug("OSC capture panel not available, skipping update")
